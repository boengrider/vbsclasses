Dim oSP : Set oSP = New SharePointLite
oSP.SharePointLite "https://volvogroup.sharepoint.com/sites/unit-rc-sk-bs-it","40784cc3-ba68-45d0-9891-f3dfa8f04d15","cDES2gLLi%2BBRI/FcUizAyZuGQFQ5p%2B6rrknc3kMBWmE=",False
oSP.UploadSingleFile Null,"Load4Me","C:\!AUTO\CZ02_VASI\CZ02_A7_AP-SK01-D_VASI_2d_202206221256.csv",True
...
Class SharePointLite
	...
	Function UploadSingleFile(sSiteUrl,sLibraryName,sFilePath,bOverwrite)
		Dim tmp,file,buffer
		oRX.Pattern = "\/sites\/.+\/"
